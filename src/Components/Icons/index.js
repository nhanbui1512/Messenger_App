...
export const ImageIcon = ({ width = 28, height = 28, className = {}, fill = '#0084ff' }) => {
  return (
    <svg className={className} height={height} viewBox="0 0 36 36" width={width}>
      <path d="M13.5 16.5a2 2 0 100-4 2 2 0 000 4z" fill={fill}></path>
      <path
        clipRule="evenodd"
...
export const Pin = ({ width = 16, height = 16, className = {} }) => {
  return (
    <svg
      viewBox="6 6 24 24"
      fill="currentColor"
...
export const Pen = ({ width = 16, height = 16, className = {} }) => {
  return (
    <svg
      viewBox="6 6 24 24"
      fill="#000"
...
export const Text = ({ width = 16, height = 16, className = {} }) => {
  return (
    <svg
      viewBox="6 6 24 24"
      fill="currentColor"
